...
ADVANCED_SETTINGS = {
    ...
    "ACCUMULATION_ANTI_RANGE_LOOKBACK": {"label": "Accumulation - nombre d'echantillons observes pour le detecteur de range", "default": 30},
    "SPOT_ACCUM_ANTI_RANGE_MIN_PCT": {"label": "Spot-Accum - mouvement minimum requis pour eviter le range (%)", "default": 2.0},
    "SPOT_ACCUM_ANTI_RANGE_LOOKBACK": {"label": "Spot-Accum - nombre d'echantillons observes pour le detecteur de range", "default": 30},
